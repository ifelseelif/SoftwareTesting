...
public class LnTest {
    ...
    public void testLn(double expected, double value) {
        Assertions.assertEquals(expected, ln.calculate(value), DELTA);
    }

    @Test
    public void testNegativeValue() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> ln.calculate(-10));
    }
    ...
    private static Stream<Arguments> provideDoubleValues() {
        return Stream.of(
                ...
                Arguments.of(-0.356674943939, 0.7)
        );
    }
